...
class Item
{
   companion object
   {
      ...
      val order = mapOf(
          ...
          "Item_Weapon_FNFal_C"	to	 count() ,
          "Item_Attach_Weapon_Upper_PM2_01_C" to  count(),
          // "Item_Attach_Weapon_Muzzle_Duckbill_C" to jsettings.Duckbill,
          "Item_Attach_Weapon_Lower_ThumbGrip_C" to  count(),
          "Item_Attach_Weapon_Lower_LightweightForeGrip_C" to  count(),
          "Item_Attach_Weapon_Lower_HalfGrip_C" to  count(),
...
//          "Item_Weapon_FlashBang_C" to count() ,
          ...
          "Item_Attach_Weapon_Upper_Scope3x_C"  to count(),
          "Item_Attach_Weapon_Upper_Scope6x_C"  to count(),
